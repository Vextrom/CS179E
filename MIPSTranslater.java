		...
		if (opName == "Add") {
			...
			if (stmt.args[0].getClass() != stmt.args[1].getClass()) {
				...
				if (stmt.args[0] instanceof VLitInt) {
					int num1 = Integer.getInteger(stmt.args[0].toString());
					int num2 = Integer.getInteger(stmt.args[1].toString());
					int num = num1 + num2;
			...
			String dest = stmt.dest.toString();
			String arg1 = stmt.args[0].toString();
			String arg2 = stmt.args[1].toString();
			this.printer.println("mul " + dest + " " + arg1 + " " + arg2);
		} else if (opName == "LtS") {
			String dest = stmt.dest.toString();
			if (stmt.args[0].getClass() != stmt.args[1].getClass()) {
				String reg = stmt.args[0].toString();
