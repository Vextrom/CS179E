...
public class VM2M {
	public static void main(String[] args) throws IOException {
		FileInputStream inputS = new FileInputStream(new File(
				"/home/jiamin/eclipse-workspace/MiniJava-Compiler/src/Factorial.vaporm"));
		VaporProgram prog = parseVapor(inputS, System.err);
